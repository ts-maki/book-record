        ...
        <x-layout.container class="bg-white rounded-lg py-4">
            ...
            <form action="{{ route('book.record', $book->id) }}" method="post" class="book__record-category pt-1">
                ...
                <div class="flex flex-col md:flex-row">
                    <div>
                        <label><input type="radio" name="category" value="ファンタジー" class="border-gray-300"><span
                                class="pl-1">ファンタジー</span></label>
                        <label><input type="radio" name="category" value="恋愛" class="border-gray-300"><span
                                class="pl-1">恋愛</span></label>
                        <label><input type="radio" name="category" value="青春" class="border-gray-300"><span
                                class="pl-1">青春</span></label>
                        <label><input type="radio" name="category" value="SF" class="border-gray-300"><span
                                class="pl-1">SF</span></label>
                    </div>
                    <div class="md:pl-4">
                        <label><input type="radio" name="category" value="ミステリー" class="border-gray-300"><span
                                class="pl-1">ミステリー</span></label>
                        <label><input type="radio" name="category" value="ホラー" class="border-gray-300"><span
                                class="pl-1">ホラー</span></label>
                        <label><input type="radio" name="category" value="仕事" class="border-gray-300"><span
                                class="pl-1">仕事</span></label>
                        <label><input type="radio" name="category" value="歴史" class="border-gray-300"><span
                ...
                <div class="sm:flex pt-4">
                    ...
                    <div class="flex flex-col sm:w-96">
                        <textarea name="content" cols="120" rows="3" class="mt-2 border-gray-300 rounded-lg"></textarea>
