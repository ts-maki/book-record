...
## はじめに
google books APIsのリクエスト超過で本の検索ができなかったら申し訳ございません。
<br>
google books APIsのリクエスト超過で本の検索ができなくなることが9月頃からあり、色々調べたつもりですが、分からず、 時間をおくと利用できるようになるというなさけない実装になり悔しいです。
<br><br>
# 本の感想共有アプリ
URL
<br>
...
- PHPファイルの一番最初にdeclare(strict_types=1)と書き、関数の引数や戻り値で型を宣言したプログラムを書けていなかった
<br><br>
